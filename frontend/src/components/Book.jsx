      ...
      <div className="m-4">
        <Link to={`/discover/books/d/${content._id}`} className="w-full">
          <div className="flex flex-col">
            <div className="h-[270px] w-[180px] max-md:h-[225px] max-md:w-[150px] border-2 border-gray-500 overflow-hidden">
              <img
            ...
            <div className="w-[180px] h-[60px] max-md:w-[150px] border-2 border-gray-500 px-2 py-1">
